...
import { createFixPullRequest } from "../utils/create-fix-pr.js";
...
export async function runCommand(
  ...
  switch (command) {
    ...
    case "fix": {
      ...
      let pullRequest: Awaited<ReturnType<typeof createFixPullRequest>> | null = null;
      if (options.createPr) {
        ...
        pullRequest = await createFixPullRequest({
          ...
          branchName: options.prBranch,
          dryRun: options.dryRun,
          body: [
            "Safe readiness assets generated by `cf-ready fix --create-pr`.",
            "",
            "Risky migration or security changes are **not** included.",
            "Review generated AI/SEO files before merging.",
          ].join("\n"),
        });
      }
